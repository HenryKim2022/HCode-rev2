...
@section('page-content')
    ...
    <div class="row">
        <div class="col-12">
            <h4 class="mb-4 mt-2">New Posts</h4>
        </div> <!-- end col -->
    </div>
    <!-- end row -->
    <div class="row">
        <div class="col-sm-6 col-lg-3">
            <div class="card position-relative">
                ...
                <span class="last-update rounded-2 position-absolute top-0 end-0 bg-success bg-opacity-75 px-2 py-1">
    ...
    {{-- <div class="row p-2 gap-2 flex-nowrap" style="width: 100%; overflow-x: auto; display: flex;" data-scrollbar> --}}

    <div class="row overflow-x-auto flex-nowrap mt-0 mb-1 mx-0">
